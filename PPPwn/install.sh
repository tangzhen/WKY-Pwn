...
[Yy]* ) 
while true; do
read -p  "$(printf '\033[33mEnter the firmware version [11.00 | 10.50 | 10.01 | 10.00  | 9.60| 9.00]: \033[0m')" FWV
case $FWV in
"" ) 
 echo -e '\033[31mCannot be empty!\033[0m';;
 * )  
...
if [[ ! "$FWV" =~ ^("11.00"|"10.50"|"10.01"|"10.00"|"9.60"|"9.00")$ ]]  ; then
echo -e '\033[31mThe version must be 11.00,10.50,10.01,10.00,9.60 or 9.00\033[0m';
else 
break;
fi
else 
